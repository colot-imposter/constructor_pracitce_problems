...
// Write your code below:
class Subject {constructor(requiresBooks){
...
// Write your code below:
class Math extends Subject {constructor(requiresCalculator, requiresBooks){
  super(requiresBooks);
...
// Write your code below:
class Geometry extends Math {constructor(requiresRuler, requiresCalculator, requiresBooks){
...
// Write your code below:
let nerdPie= new Calculus(false, 'Ti-89')
